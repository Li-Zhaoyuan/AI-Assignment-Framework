...
Then generate the VBO/IBO and store them in MyMeshComponent object
...
*/
/******************************************************************************/
MyMeshComponent* MyMeshBuilder::GenerateAxes(const std::string &meshName, float lengthX, float lengthY, float lengthZ)
{
    Vertex v;
    ...
    MyMeshComponent *mesh = new MyMeshComponent(meshName);
    ...
    mesh->mode = MyMeshComponent::DRAW_LINES;
...
*/
/******************************************************************************/
MyMeshComponent* MyMeshBuilder::GenerateCrossHair(const std::string &meshName, float colour_r, float colour_g, float colour_b, float length)
{
...
*/
/******************************************************************************/
MyMeshComponent* MyMeshBuilder::GenerateQuad(const std::string &meshName, Color color, float length)
{
    Vertex v;
    std::vector<Vertex> vertex_buffer_data;
    std::vector<GLuint> index_buffer_data;
    ...
    mesh->indexSize = index_buffer_data.size();
    mesh->mode = MyMeshComponent::DRAW_TRIANGLES;
...
*/
/******************************************************************************/
MyMeshComponent* MyMeshBuilder::GenerateCube(const std::string &meshName, Color color, float length)
{
    Vertex v;
    std::vector<Vertex> vertex_buffer_data;
...
float MyMeshBuilder::CircleX(float theta)
{
    return cos(Math::DegreeToRadian(theta));
}

float MyMeshBuilder::CircleZ(float theta)
{
    return sin(Math::DegreeToRadian(theta));
}

MyMeshComponent* MyMeshBuilder::GenerateCircle(const std::string &meshName, Color color, unsigned numSlices)
{
    std::vector<Vertex> vertex_buffer_data;
    std::vector<GLuint> index_buffer_data;
    Vertex v;
    ...
    mesh->indexSize = index_buffer_data.size();
    mesh->mode = MyMeshComponent::DRAW_TRIANGLE_STRIP;

    return mesh;
}

MyMeshComponent* MyMeshBuilder::GenerateRing(const std::string &meshName, Color color, unsigned numSlice, float outerR, float innerR)
{
    std::vector<Vertex> vertex_buffer_data;
    std::vector<GLuint> index_buffer_data;
    Vertex v;
...
float MyMeshBuilder::sphereX(float phi, float theta)
{
    return cos(Math::DegreeToRadian(phi)) * cos(Math::DegreeToRadian(theta));
}
float MyMeshBuilder::sphereY(float phi, float theta)
{
    return sin(Math::DegreeToRadian(phi));
}
float MyMeshBuilder::sphereZ(float phi, float theta)
{
    return cos(Math::DegreeToRadian(phi)) * sin(Math::DegreeToRadian(theta));
}

MyMeshComponent* MyMeshBuilder::GenerateSphere(const std::string &meshName, Color color, unsigned numStack, unsigned numSlice, float radius)
{
    std::vector<Vertex> vertex_buffer_data;
    std::vector<GLuint> index_buffer_data;
...
MyMeshComponent* MyMeshBuilder::GenerateCone(const std::string &meshName, Color color, unsigned numSlice, float radius, float height)
{
    std::vector<Vertex> vertex_buffer_data;
    std::vector<GLuint> index_buffer_data;
...
MyMeshComponent* MyMeshBuilder::GenerateOBJ(const std::string &meshName, const std::string &file_path)
{
...
MyMeshComponent* MyMeshBuilder::GenerateText(const std::string &meshName, unsigned numRow, unsigned numCol)
{
    Vertex v;
    std::vector<Vertex> vertex_buffer_data;
    std::vector<GLuint> index_buffer_data;
...
MyMeshComponent* MyMeshBuilder::GenerateSkyPlane(const std::string &meshName, Color color, int slices, float PlanetRadius, float AtmosphereRadius, float hTile, float vTile)
{
    std::vector<Vertex> vertex_buffer_data;
    std::vector<GLuint> index_buffer_data;

    //Checking no. of Slices
    (slices < 1) ? (slices = 1) : (slices > 256) ? (slices = 256) : (slices);

    //Calculating valuses necessary for plane size
...
MyMeshComponent* MyMeshBuilder::GenerateTerrain(const std::string &meshName, const std::string& file_path, std::vector<unsigned char>& heightMap)
{
    std::vector<Vertex> vertex_buffer_data;
    std::vector<GLuint> index_buffer_data;
...
SpriteComponent* MyMeshBuilder::GenerateSpriteAnimation(const std::string &meshName, unsigned numRow, unsigned numCol)
{
    Vertex v;
    std::vector<Vertex> vertex_buffer_data;
    std::vector<GLuint> index_buffer_data;
    ...
    //MyMeshComponent *mesh = new MyMeshComponent(meshName);
    SpriteComponent *mesh = new SpriteComponent(meshName, numRow, numCol);
...
*/
/******************************************************************************/
MyMeshComponent* MyMeshBuilder::GenerateMinimap(const std::string &meshName, Color color, float length)
{
    Vertex v;
    std::vector<Vertex> vertex_buffer_data;
    std::vector<GLuint> index_buffer_data;
...
*/
/******************************************************************************/
MyMeshComponent* MyMeshBuilder::GenerateMinimapBorder(const std::string &meshName, Color color, float length)
{
    Vertex v;
    std::vector<Vertex> vertex_buffer_data;
    std::vector<GLuint> index_buffer_data;
...
*/
/******************************************************************************/
MyMeshComponent* MyMeshBuilder::GenerateMinimapAvatar(const std::string &meshName, Color color, float length)
{
    Vertex v;
    std::vector<Vertex> vertex_buffer_data;
    std::vector<GLuint> index_buffer_data;
